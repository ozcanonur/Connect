      ...
      <Grid container direction='column'>
        <Grid item md>
          <Grid container direction='row'>
            <Grid item xs={8}>
              ...
              <Typography variant='h3' style={{ paddingTop: '1em' }}>
        ...
        <Grid item md>
          <Typography variant='body1'>
            Öğrencinin, velinin ve okulun ihtiyacının belirlenmesi, Öğrenci ve okul için uygun olan
            kurumun tespit edilmesi, Öğrencinin kurum, konaklama, ulaşım, yemek, vize gibi konularda
            bilgilendirilmesi ve seçeneklerin sunulması, Vize belgelerinin toplanması, Konsolosluk
            vize randevusunun alınması, Gerekli yazışmaların yapılması, Uçak biletinin temin
            edilmesi, Seyahat ve sağlık sigortasının yapılması, Eğitimin başlangıcından sonuna her
            an destek olacak bir refakatçinin sağlanması. Eğitim boyunca ülkenin kültürünü tanımak,
            uluslararası arkadaşlıkları pekiştirmek ve pratik yapabilmek için çeşitli gezi
